    ...
    return (
        <aside className="sidebar">
            ...
            <div className="sidebar-div">
                ...
                <nav>
                    <Link href="/dashboard" className="sidebar-link"><img src="/desktop/sidebar/zakladka_pulpit.png" alt=""/>{t.sidebar.b1}</Link>
                    <Link href="/dashboard" className="sidebar-link"><img src="/desktop/sidebar/zakladka_znizki.png" alt=""/>{t.sidebar.b2}</Link>
                    <Link href="/dashboard" className="sidebar-link"><img src="/desktop/sidebar/zakladka_odkrywaj.png" alt=""/>{t.sidebar.b3}</Link>
                    <Link href="/dashboard" className="sidebar-link"><img src="/desktop/sidebar/zakladka_ustawienia.png" alt=""/>{t.sidebar.b4}</Link>
                    <Link href="/dashboard" className="sidebar-link"><img src="/desktop/sidebar/zakladka_pomoc.png" alt=""/>{t.sidebar.b5}</Link>
                </nav>
            </div>
            <hr className="hr-sidebar"/>
            <div className="sidebar-div">
